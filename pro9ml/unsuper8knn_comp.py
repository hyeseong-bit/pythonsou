...
# k = 3 이므로 71, 82, 31 번 자료가 분류에 참여함. 새로운 자료와 거리는 0.223, 0.3, 0.435
...
print(f'새로운 값은 군집{clu_pred}로 분류됨')

print()
# 군집 모델 성능 파악
pred_cluster = KMeansModel.predict(test_x)
print('pred_cluster : ', pred_cluster)  #   [2 1 0 2 2 1 2 0 2 2 0 1 1 1 1 2 0 2 2 

# 평가 데이터를 적용해 예측하 군집을, 각 iris의 종류를 의미하는 라벨값으로
...
np_arr[np_arr == 4] == 0    # 군집 4을 0(versicolor)로 변경
np_arr[np_arr == 5] == 1    # 군집 5을 1(versicolor)로 변경
print('np_arr : ', np_arr)
