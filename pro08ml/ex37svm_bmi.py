# BMI(Body Mass Index)는 체질량 지수로, 몸무게(kg)를 키의 제곱으로 나눈 값.
...
x_train, x_test, y_train, y_test = train_test_split(
    wh, label, test_size=0.3, random_state=0
)
...
print('3회 각 정확도 : ', cross_val)
print('평균 정확도 : ', cross_val.mean())
...
# 숫자 결과를 문자로 다시 바꾸기
label_dict = {0:'thin', 1:'normal', 2:'fat'}
print('새로운 값 예측 해석 : ', [label_dict[i] for i in new_pred])
