...
print(stats.shapiro(x1).pvalue) # 0.27487 > 0.05
print(stats.shapiro(x2).pvalue) # 0.10214 > 0.05

# 대응표본 t검정
print(stats.ttest_rel(x1, x2))
# statistic=-3.003102, pvalue=0.0033837, df=99
# 해석 : pvalue=0.0033837 > alpha 0.05 이므로 귀무가설 기각
