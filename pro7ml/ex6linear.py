...
print('방법4 : make_regressiom 사용. model 생성 X')
...
print(model) # LinregressResult(slope=np.float64(0.6514309527270089), intercept=np.float64(-2.8564471221976504), rvalue=np.float64(0.8822203446134709)
