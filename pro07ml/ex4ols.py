...
print(0.96 * 0 + -0.9899999999999998) # 실제값 -1,  예측값 -0.989999
print(0.96 * 1 + -0.9899999999999998) # 실제값 0.2, 예측값 -0.029999
print(0.96 * 2 + -0.9899999999999998) # 실제값 0.5, 예측값  0.930000
print(0.96 * 3 +-0.9899999999999998)  # 실제값 2.1, 예측값  1.890000
