...
# 이를 softmax regression 또는 multinormial logistic regression 이라고 부른다
...
"""
# Scaling (데이터 크기 표준화 - 최적화 과정에서 안전성, 수렴속도 향상, 과적합/과소적합 방지 등의 효과)
sc = StandardScaler()
