# 최근접 이윳(K-Nearest Neighbors) - breast_cancer dataset 사용
...
print('새로운 결과가 예측 결과')
print('예측 : ', perediction[0],', 0:악성 , 1:양성')
print('확률 : ', proba)
