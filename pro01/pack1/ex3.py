...
print(k, type(k))
print(t[0], ' ', t[0:2])
# t[] = 77 'tuple' object does not support item assignment
...
print(ss)
ss2 = {3,4}
print(ss.union(ss2)) #합집함
print(ss.intersection(ss2)) #교집함
print(ss - ss2, ss | ss2, ss & ss2)  # 차, 합, 교집함
...
ss.remove(6)   # 값 삭제
# ss.remove(6)   # 값 삭제: 해당 값 없으면 통과 에러
print(ss)
