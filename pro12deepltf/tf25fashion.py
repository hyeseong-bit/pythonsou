...
class_names = ['T-shirt/top','Troiser','Pullover','Dress','Coat','Sandal','Shirt','Sneaker','Bag','Ankle boot']
...
print(f'test_loss:{test_loss:.4f}, test_ac:{test_acc:.4f}')
...
def show_one_prediction(i, pred, y_true, x_img): # 1개 이미지
...
show_one_prediction(0, pred, y_test, x_test)
